...
function anno_rtag(xpath)
{
    ...
    if (window.getSelection().toString().length!==0) {    
        ...
        var popUpList = $j('<div><form><input type=\"radio\" name=\"r\" value=\"A\" id=\"radio\" checked=\"checked\">Date<br> <input value=\"B\" type=\"radio\" name = \"r\" id=\"radio\">Currency<br> <input type=\"radio\" name=\"r\" id=\"radio\" value=\"C\">Unit<br> <button id=\"submitunique\">submit</button></form> </div>');
        popUpList.dialog();
